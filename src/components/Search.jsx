...
export default function Search({ setSearch }) {
  ...
  return (
    ...
    <div className="w-full max-w-5xl m-auto p-4 sm:px-12 bg-[#1C1C1C]">
      <div 
        className="relative bg-[#3b3a3a] text-gray-200 shadow-md text-md rounded-full px-4 py-2 outline-none w-full"
      >
        <input 
          value={searchQuery}
          onChange={e => setSearchQuery(e.currentTarget.value)}
          className="w-full pl-6  bg-[#3b3a3a] border-none focus:outline-none"
